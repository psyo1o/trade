...
## 2026-05-01 추가 관찰
- 운영 로직 보강(동기화·코인 매수창·텔레 매수 패스)은 **분리 완료 범위를 깨지 않고** `run_bot.py` / `sync_positions.py` 에 국소 반영됨.
- 모듈화 후보 우선순위 자체는 변하지 않음 — 자세한 로드맵은 `MODULARIZATION_ROADMAP_2026-04-22.md`, 다음 할 일은 `MODULARIZATION_NEXT_STEPS_2026-04-21.md` 참고.
